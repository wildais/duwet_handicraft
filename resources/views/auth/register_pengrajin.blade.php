...
<html lang="en">
  <head>
    ...
    <title>Register Pengrajin</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6>Apakah anda seorang pengrajin?</h6>
                <h6 class="font-weight-light">Mendaftar itu mudah. Hanya butuh beberapa langkah</h6>
                <form class="pt-3" method="POST" action="{{ route('register') }}">
                @csrf
                  <div class="form-group">
                  <input id="roles" type="hidden" class="form-control" name="roles" value="pengrajin">
                ...
                @enderror
                  ...
                  <div class="mt-3">
                    <button type="submit" class="btn btn-block btn-gradient-dark btn-lg font-weight-medium auth-form-btn">Daftar</button>
                  </div>
                  <div class="text-center mt-4 font-weight-light">
                    Sudah punya akun? <a href="{{ route('login') }}" class="text-primary">Masuk</a>
                  </div>
                  <hr>
                  <div class="text-center mt-4 font-weight-light"> Anda seorang <strong>Customer</strong>? <a href="/register" class="text-orange"><strong>Daftar sebagai customer</strong></a>
                  </div>
                </form>
              </div>
            </div>
