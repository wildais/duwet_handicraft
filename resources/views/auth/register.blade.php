            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                @csrf
                  ...
                  <input id="roles" type="hidden" class="form-control" name="roles" value="customer">
                ...
                @enderror
                  ...
                  <hr>
                  <div class="text-center mt-4 font-weight-light"> Anda seorang <strong>Pengrajin</strong>? <a href="/register-pengrajin" class="text-orange"><strong>Daftar sebagai pengrajin</strong></a>
                  </div>
                </form>
              </div>
            </div>
